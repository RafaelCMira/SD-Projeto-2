package sd2223.trab1.api.soap.push;
...
public interface FeedsService extends sd2223.trab1.api.soap.FeedsService {
    ...
    @WebMethod
    void push_PushMessage(String secret, PushMessage msg) throws FeedsException;

    @WebMethod
    void push_updateFollowers(String secret, String user, String follower, boolean following) throws FeedsException;
}