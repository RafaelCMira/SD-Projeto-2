...
public class SoapFeedsPushWebService extends SoapFeedsWebService<FeedsPush> implements FeedsService {
    ...
    @Override
    public void push_PushMessage(String secret, PushMessage msg) throws FeedsException {
        super.fromJavaResult(impl.push_PushMessage(secret, msg));
    }

    @Override
    public void push_updateFollowers(String secret, String user, String follower, boolean following) throws FeedsException {
